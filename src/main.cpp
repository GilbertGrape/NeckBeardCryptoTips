...
const string strMessageMagic = "NeckBeardCryptoTips Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexPrev->nHeight >= 2 && pindexPrev->nHeight <= 175200){
      nSubsidy = 150 * COIN;
    } else if(pindexPrev->nHeight >= 175200 && pindexPrev->nHeight < 350400){
      nSubsidy = 75 * COIN;
    } else if(pindexPrev->nHeight >= 350400 && pindexPrev->nHeight < 525600){
      nSubsidy = 37.5 * COIN;
    } else if(pindexPrev->nHeight >= 525600 && pindexPrev->nHeight < 700800){
      nSubsidy = 18.75 * COIN;
    }
...
{
    RenameThread("NeckBeardCryptoTips-loadblk");

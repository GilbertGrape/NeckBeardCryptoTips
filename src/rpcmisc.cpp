...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <NeckBeardCryptoTipsaddress>\n"
            "Return information about <NeckBeardCryptoTipsaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <NeckBeardCryptoTipspubkey>\n"
            "Return information about <NeckBeardCryptoTipspubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <NeckBeardCryptoTipsaddress> <signature> <message>\n"

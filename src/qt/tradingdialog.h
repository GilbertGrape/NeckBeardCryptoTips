...
private slots:
    ...
    QString BuyNeckBeardCryptoTips(QString OrderType, double Quantity, double Rate);
    QString SellNeckBeardCryptoTips(QString OrderType, double Quantity, double Rate);

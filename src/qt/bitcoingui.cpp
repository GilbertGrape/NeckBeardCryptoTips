...
{
    resize(900, 520);
    setWindowTitle(tr("NeckBeardCryptoTips") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("NeckBeardCryptoTips");
    setStyleSheet("#NeckBeardCryptoTips { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a NeckBeardCryptoTips address"));
    ...
    aboutAction = new QAction(tr("&About NeckBeardCryptoTips"), this);
    aboutAction->setToolTip(tr("Show information about NeckBeardCryptoTips"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for NeckBeardCryptoTips"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }" 
                           "QToolButton:hover { background-color: #696969; border: none; padding-top: 5px; padding-bottom: 5px; }" 
                           ...
                           "#tabs { color: #000000; background-color: #708090; border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("NeckBeardCryptoTips client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("NeckBeardCryptoTips client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NeckBeardCryptoTips network", "", count));
}
...
{
    QString strTitle = tr("NeckBeardCryptoTips") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NeckBeardCryptoTips address or malformed URI parameters."));
    }

...
public:
    ...
    QLabel *label232_2;
    QLabel *NeckBeardCryptoTipsAvailableLabel;
    QLabel *labelNeckBeardCryptoTips;
    QPushButton *Buy_Max_Amount;
    QLineEdit *UnitsInput;
    QLabel *label_4;
    QPushButton *Sell_Max_Amount;
    QLineEdit *UnitsInputNeckBeardCryptoTips;
    QLabel *label_22;
    QLabel *label_6;
    ...
    QLabel *label_17;
    QPushButton *BuyNeckBeardCryptoTips;
    QPushButton *SellNeckBeardCryptoTipsBTN;
    QTableWidget *BidsTable;
    QLabel *BtcDemand;
    QLabel *AsksCount;
    QLabel *BtcSupply;
    QLabel *NeckBeardCryptoTipsDemand;
    QLabel *NeckBeardCryptoTipsSupply;
    QLabel *BidsCount;
    QWidget *tab;
    ...
    QLabel *label_29;
    QLabel *BittrexNeckBeardCryptoTipsLabel;
    QLabel *label_30;
    ...
    QLabel *label_11;
    QLabel *NeckBeardCryptoTipsBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *NeckBeardCryptoTipsAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *NeckBeardCryptoTipsPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        NeckBeardCryptoTipsAvailableLabel = new QLabel(BuyTab);
        NeckBeardCryptoTipsAvailableLabel->setObjectName(QStringLiteral("NeckBeardCryptoTipsAvailableLabel"));
        QPalette palette1;
        ...
        NeckBeardCryptoTipsAvailableLabel->setPalette(palette1);
        NeckBeardCryptoTipsAvailableLabel->setFont(font3);
        NeckBeardCryptoTipsAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(NeckBeardCryptoTipsAvailableLabel);

        labelNeckBeardCryptoTips = new QLabel(BuyTab);
        labelNeckBeardCryptoTips->setObjectName(QStringLiteral("labelNeckBeardCryptoTips"));
        labelNeckBeardCryptoTips->setFont(font3);

        horizontalLayout->addWidget(labelNeckBeardCryptoTips);
        ...
        UnitsInputNeckBeardCryptoTips = new QLineEdit(BuyTab);
        UnitsInputNeckBeardCryptoTips->setObjectName(QStringLiteral("UnitsInputNeckBeardCryptoTips"));
        UnitsInputNeckBeardCryptoTips->setMinimumSize(QSize(0, 0));
        UnitsInputNeckBeardCryptoTips->setFont(font5);

        gridLayout_6->addWidget(UnitsInputNeckBeardCryptoTips, 4, 9, 1, 1);
        ...
        BuyNeckBeardCryptoTips = new QPushButton(BuyTab);
        BuyNeckBeardCryptoTips->setObjectName(QStringLiteral("BuyNeckBeardCryptoTips"));

        gridLayout_6->addWidget(BuyNeckBeardCryptoTips, 7, 3, 1, 1);

        SellNeckBeardCryptoTipsBTN = new QPushButton(BuyTab);
        SellNeckBeardCryptoTipsBTN->setObjectName(QStringLiteral("SellNeckBeardCryptoTipsBTN"));

        gridLayout_6->addWidget(SellNeckBeardCryptoTipsBTN, 7, 9, 1, 1);
        ...
        NeckBeardCryptoTipsDemand = new QLabel(BuyTab);
        NeckBeardCryptoTipsDemand->setObjectName(QStringLiteral("NeckBeardCryptoTipsDemand"));
        QFont font6;
        font6.setPointSize(8);
        NeckBeardCryptoTipsDemand->setFont(font6);
        NeckBeardCryptoTipsDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(NeckBeardCryptoTipsDemand, 0, 1, 1, 5);

        NeckBeardCryptoTipsSupply = new QLabel(BuyTab);
        NeckBeardCryptoTipsSupply->setObjectName(QStringLiteral("NeckBeardCryptoTipsSupply"));
        NeckBeardCryptoTipsSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(NeckBeardCryptoTipsSupply, 0, 9, 1, 3);
        ...
        BittrexNeckBeardCryptoTipsLabel = new QLabel(tab);
        BittrexNeckBeardCryptoTipsLabel->setObjectName(QStringLiteral("BittrexNeckBeardCryptoTipsLabel"));
        QPalette palette7;
        ...
        BittrexNeckBeardCryptoTipsLabel->setPalette(palette7);
        BittrexNeckBeardCryptoTipsLabel->setFont(font7);
        BittrexNeckBeardCryptoTipsLabel->setAutoFillBackground(false);
        BittrexNeckBeardCryptoTipsLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexNeckBeardCryptoTipsLabel);
        ...
        NeckBeardCryptoTipsBalanceLabel = new QLabel(BalanceTab);
        NeckBeardCryptoTipsBalanceLabel->setObjectName(QStringLiteral("NeckBeardCryptoTipsBalanceLabel"));
        NeckBeardCryptoTipsBalanceLabel->setFont(font4);
        NeckBeardCryptoTipsBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(NeckBeardCryptoTipsBalanceLabel, 0, 3, 1, 1);
        ...
        NeckBeardCryptoTipsAvailableLabel_2 = new QLabel(BalanceTab);
        NeckBeardCryptoTipsAvailableLabel_2->setObjectName(QStringLiteral("NeckBeardCryptoTipsAvailableLabel_2"));
        NeckBeardCryptoTipsAvailableLabel_2->setFont(font4);
        NeckBeardCryptoTipsAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(NeckBeardCryptoTipsAvailableLabel_2, 1, 3, 1, 1);
        ...
        NeckBeardCryptoTipsPendingLabel = new QLabel(BalanceTab);
        NeckBeardCryptoTipsPendingLabel->setObjectName(QStringLiteral("NeckBeardCryptoTipsPendingLabel"));
        NeckBeardCryptoTipsPendingLabel->setFont(font4);
        NeckBeardCryptoTipsPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(NeckBeardCryptoTipsPendingLabel, 2, 3, 1, 1);
        ...
        NeckBeardCryptoTipsBalanceLabel->raise();
        NeckBeardCryptoTipsAvailableLabel_2->raise();
        NeckBeardCryptoTipsPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "NBCT Available:", 0));
        NeckBeardCryptoTipsAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelNeckBeardCryptoTips->setText(QApplication::translate("tradingDialog", " NBCT", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "NBCT", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "NBCT", 0));
        ...
        BuyNeckBeardCryptoTips->setText(QApplication::translate("tradingDialog", "Buy NBCT", 0));
        SellNeckBeardCryptoTipsBTN->setText(QApplication::translate("tradingDialog", "Sell NBCT", 0));
        ...
        NeckBeardCryptoTipsDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 NBCT", 0));
        NeckBeardCryptoTipsSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 NBCT", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in NBCT:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "NBCT", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "NBCT Balance:", 0));
        BittrexNeckBeardCryptoTipsLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "NBCT", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "NBCT Balance:", 0));
        NeckBeardCryptoTipsBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "NBCT Available:", 0));
        NeckBeardCryptoTipsAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "NBCT Pending:", 0));
        NeckBeardCryptoTipsPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate NBCT Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw NBCT:", 0));

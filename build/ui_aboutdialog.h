...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About NeckBeardCryptoTips", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>NeckBeardCryptoTips</b> version", 0));
...
"Copyright \302\251 2017-2018 The NeckBeardCryptoTips developers", 0));

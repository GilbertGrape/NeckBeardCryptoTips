...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 NBCT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 NBCT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NBCT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NBCT"));
